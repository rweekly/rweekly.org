...
+ [Linking 2 Interactive Plots in R without Shiny: plotly, crosstalk
Plotly offers so much more than ggplotly(). In combination with crosstalk, you can link two interactive plots so that selections on one result in highlighting cases on the other.](https://youtu.be/Htg_l8lzgMs)
...
+ [An Accessible pkgdown Template](https://amirmasoudabdol.github.io/preferably)
...
+ [Rcpp 1.0.6: Some Updates](http://dirk.eddelbuettel.com/blog/2021/01/15#rcpp_1.0.6)
...
+ [glmnet v4.1: regularized Cox models for start, stop and stratified data](https://statisticaloddsandends.wordpress.com/2021/01/14/glmnet-v4-1-regularized-cox-models-for-start-stop-and-stratified-data/)
...
+ [BH 1.75.0-0: New upstream release, added Beast](http://dirk.eddelbuettel.com/blog/2021/01/11#bh_1.75.0-0)
...
+ [RcppArmadillo 0.10.1.2.2: Minor update](http://dirk.eddelbuettel.com/blog/2021/01/10#rcpparmadillo_0.10.1.2.2)
