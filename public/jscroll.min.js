 ...
 * @preserve
 */
!function(m){"use strict";m.jscroll={defaults:{debug:!1,autoTrigger:!0,autoTriggerUntil:!1,loadingHtml:"<small>Loading...</small>",loadingFunction:!1,padding:0,nextSelector:"a:last",contentSelector:"",pagingSelector:"",callback:!1,loaded:function(n,t,e){}}};var l=function(a,n){var t,e=a.data("jscroll"),l="function"==typeof n?{callback:n}:n,s=m.extend({},m.jscroll.defaults,l,e||{}),d="visible"===a.css("overflow-y"),o=a.find(s.nextSelector).first(),r=m(window),i=m("body"),f=d?r:a,c=m.trim(o.prop("href")+" "+s.contentSelector),g=function(){a.find(".jscroll-inner").length||a.contents().wrapAll('<div class="jscroll-inner" />')},u=function(n){s.pagingSelector?n.closest(s.pagingSelector).hide():n.parent().not(".jscroll-inner,.jscroll-added").addClass("jscroll-next-parent").hide().length||n.wrap('<div class="jscroll-next-parent" />').parent().hide()},p=function(){return f.unbind(".jscroll").removeData("jscroll").find(".jscroll-inner").children().unwrap().filter(".jscroll-added").children().unwrap()},j=function(){if(a.is(":visible")){g();var n=a.find("div.jscroll-inner").first(),t=a.data("jscroll"),e=parseInt(a.css("borderTopWidth"),10),l=isNaN(e)?0:e,o=parseInt(a.css("paddingTop"),10)+l,r=d?f.scrollTop():a.offset().top,i=n.length?n.offset().top:0,c=Math.ceil(r-i+f.height()+o);if(!t.waiting&&c+s.padding>=n.outerHeight())return b("info","jScroll:",n.outerHeight()-c,"from bottom. Loading next request..."),v()}},h=function(){var n=a.find(s.nextSelector).first();if(n.length)if(s.autoTrigger&&(!1===s.autoTriggerUntil||0<s.autoTriggerUntil)){u(n);var t=i.height()-a.offset().top;(a.height()<t?a.height():t)<=(0<a.offset().top-r.scrollTop()?r.height()-(a.offset().top-m(window).scrollTop()):r.height())&&j(),f.unbind(".jscroll").bind("scroll.jscroll",function(){return j()}),0<s.autoTriggerUntil&&s.autoTriggerUntil--}else f.unbind(".jscroll"),n.bind("click.jscroll",function(){return u(n),v(),!1})},v=function(){var n=a.find("div.jscroll-inner").first(),r=a.data("jscroll");return r.waiting=!0,n.append('<div class="jscroll-added" />').children(".jscroll-added").last().html('<div class="jscroll-loading" id="jscroll-loading">'+s.loadingHtml+"</div>").promise().done(function(){s.loadingFunction&&s.loadingFunction()}),a.animate({scrollTop:n.outerHeight()},0,function(){var o=r.nextHref;n.find("div.jscroll-added").last().load(o,function(n,t){if("error"===t)return p();var e,l=m(this).find(s.nextSelector).first();r.waiting=!1,r.nextHref=!!l.prop("href")&&m.trim(l.prop("href")+" "+s.contentSelector),m(".jscroll-next-parent",a).remove(),(e=e||a.data("jscroll"))&&e.nextHref?h():(b("warn","jScroll: nextSelector not found - destroying"),p()),s.callback&&s.callback.call(this,o),s.loaded&&s.loaded(n),b("dir",r)})})},b=function(n){if(s.debug&&"object"==typeof console&&("object"==typeof n||"function"==typeof console[n]))if("object"==typeof n){var t=[];for(var e in n)"function"==typeof console[e]?(t=n[e].length?n[e]:[n[e]],console[e].apply(console,t)):console.log.apply(console,t)}else console[n].apply(console,Array.prototype.slice.call(arguments,1))};return a.data("jscroll",m.extend({},e,{initialized:!0,waiting:!1,nextHref:c})),g(),(t=m(s.loadingHtml).filter("img").attr("src"))&&((new Image).src=t),h(),m.extend(a.jscroll,{destroy:p}),a};m.fn.jscroll=function(e){return this.each(function(){var n=m(this),t=n.data("jscroll");t&&t.initialized||l(n,e)})}}(jQuery);
...
function tocify_content(){
  var toc_all_header = document.querySelectorAll('#toc .tocify-header');
  for(var i =0; i<toc_all_header.length; i++){
    var li_elt = toc_all_header[i].querySelector('li');
    var header_li = li_elt.getAttribute('data-unique');

    li_elt.setAttribute('onclick',' _paq.push(["trackEvent", "toc_nav", "' + header_li + '", "main'+i + '"]);');

    var small_elts = toc_all_header[i].querySelectorAll('.tocify-subheader li');
      for(var j =0; j<small_elts.length; j++){
        var small_elt = small_elts[j];
        small_elt.setAttribute('onclick',' _paq.push(["trackEvent", "toc_nav", "' + header_li + '", "'+ small_elt.getAttribute('data-unique') + '"]);');
      }
  }
}
...
$('.content').jscroll({
    ...
    loaded: function(result) {
      console.log('loaded');
      var $result = $(result);
      $result.find(".inf-detail").appendTo('body');
    },
    callback: function(){
      // NProgress.done();
      ...
      tocdiv.id = "toc";
      document.body.insertBefore(tocdiv, document.body.firstElementChild);
      if (linkifyAnchors){
      ...
      setTimeout(function(){
          this.scrollTop = tocdiv.scrollHeight;
      }.bind(tocdiv), 100);
...
if (document.getElementById("toTop")){
  ...
  return $("html, body").animate({
    scrollTop: 0
  }, d.scrollSpeed, d.easingType), $("#" + d.containerHoverID, this).stop().animate({
    opacity: 0
  ...
  $(window).scroll(function () {
    ...
    'undefined' == typeof document.body.style.maxHeight && $(e).css({
      position: 'absolute',
      top: b + $(window).height() - 50
      });

      if (b > d.min ){
        $(e).fadeIn(d.inDelay) ;
      } else {
        $(e).fadeOut(d.Outdelay);
      }
  });
}

(function(window){var checkstatus=function(options){this._options={checkOnLoad:false,resetOnEnd:false,loopCheckTime:50,loopMaxNumber:5,baitClass:"pub_300x250 pub_300x250m pub_728x90 text-ad textAd text_ad text_ads text-ads text-ad-links",baitStyle:"width: 1px !important; height: 1px !important; position: absolute !important; left: -10000px !important; top: -1000px !important;",debug:false};this._var={version:"3.2.1",bait:null,checking:false,loop:null,loopNumber:0,event:{detected:[],notDetected:[]}};
if(options!==undefined)this.setOption(options);var self=this;var eventCallback=function(){setTimeout(function(){if(self._options.checkOnLoad===true){if(self._options.debug===true)self._log("onload->eventCallback","A check loading is launched");if(self._var.bait===null)self._creatBait();setTimeout(function(){self.check()},1)}},1)};if(window.addEventListener!==undefined)window.addEventListener("load",eventCallback,false);else window.attachEvent("onload",eventCallback)};checkstatus.prototype._options=
null;checkstatus.prototype._var=null;checkstatus.prototype._bait=null;checkstatus.prototype._log=function(method,message){console.log("[checkstatus]["+method+"] "+message)};checkstatus.prototype.setOption=function(options,value){if(value!==undefined){var key=options;options={};options[key]=value}for(var option in options){this._options[option]=options[option];if(this._options.debug===true)this._log("setOption",'The option "'+option+'" he was assigned to "'+options[option]+'"')}return this};checkstatus.prototype._creatBait=
function(){var bait=document.createElement("div");bait.setAttribute("class",this._options.baitClass);bait.setAttribute("style",this._options.baitStyle);this._var.bait=window.document.body.appendChild(bait);this._var.bait.offsetParent;this._var.bait.offsetHeight;this._var.bait.offsetLeft;this._var.bait.offsetTop;this._var.bait.offsetWidth;this._var.bait.clientHeight;this._var.bait.clientWidth;if(this._options.debug===true)this._log("_creatBait","Bait has been created")};checkstatus.prototype._destroyBait=
function(){window.document.body.removeChild(this._var.bait);this._var.bait=null;if(this._options.debug===true)this._log("_destroyBait","Bait has been removed")};checkstatus.prototype.check=function(loop){if(loop===undefined)loop=true;if(this._options.debug===true)this._log("check","An audit was requested "+(loop===true?"with a":"without")+" loop");if(this._var.checking===true){if(this._options.debug===true)this._log("check","A check was canceled because there is already an ongoing");return false}this._var.checking=
true;if(this._var.bait===null)this._creatBait();var self=this;this._var.loopNumber=0;if(loop===true)this._var.loop=setInterval(function(){self._checkBait(loop)},this._options.loopCheckTime);setTimeout(function(){self._checkBait(loop)},1);if(this._options.debug===true)this._log("check","A check is in progress ...");return true};checkstatus.prototype._checkBait=function(loop){var detected=false;if(this._var.bait===null)this._creatBait();if(window.document.body.getAttribute("abp")!==null||this._var.bait.offsetParent===
...
false}};checkstatus.prototype._stopLoop=function(detected){clearInterval(this._var.loop);this._var.loop=null;this._var.loopNumber=0;if(this._options.debug===true)this._log("_stopLoop","A loop has been stopped")};checkstatus.prototype.emitEvent=function(detected){if(this._options.debug===true)this._log("emitEvent","An event with a "+(detected===true?"positive":"negative")+" detection was called");var fns=this._var.event[detected===true?"detected":"notDetected"];for(var i in fns){if(this._options.debug===
true)this._log("emitEvent","Call function "+(parseInt(i)+1)+"/"+fns.length);if(fns.hasOwnProperty(i))fns[i]()}if(this._options.resetOnEnd===true)this.clearEvent();return this};checkstatus.prototype.clearEvent=function(){this._var.event.detected=[];this._var.event.notDetected=[];if(this._options.debug===true)this._log("clearEvent","The event list has been cleared")};checkstatus.prototype.on=function(detected,fn){this._var.event[detected===true?"detected":"notDetected"].push(fn);if(this._options.debug===
true)this._log("on",'A type of event "'+(detected===true?"detected":"notDetected")+'" was added');return this};checkstatus.prototype.onDetected=function(fn){return this.on(true,fn)};checkstatus.prototype.onNotDetected=function(fn){return this.on(false,fn)};window.checkstatus=checkstatus;if(window.checkstatus===undefined)window.checkstatus=new checkstatus({checkOnLoad:true,resetOnEnd:true})})(window);var checkobj=new checkstatus({checkOnLoad:true,resetOnEnd:true,debug:false,loopCheckTime:1E3});
_paq.push(["trackEvent","checkstatus","null"]);window.checkstatus_sended=false;function statuson(){if(window.checkstatus_sended===false){_paq.push(["trackEvent","checkstatus","on"]);window.checkstatus_sended=true}}if(typeof checkstatus==="undefined")statuson();else{checkobj.onDetected(statuson);checkobj.on(true,statuson)};
